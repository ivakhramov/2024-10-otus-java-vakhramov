...
public class Message {
    ...
    public ObjectForMessage getField13() {
        ...
        if (this.field13.getData() != null) {
            field13Copy.setData(new ArrayList<>(this.field13.getData()));
        } else {
    ...
    public String toString() {
        return "Message{" + "id="
                ...
                + field11 + '\'' + ", field12='"
                + field12 + '\'' + ", field13="
                + (field13 != null && field13.getData() != null
                        ? field13.getData().toString()
                        : "null") + '}';
    }
        ...
        private Builder(
            ...
            if (field13 != null) {
                ...
                if (field13.getData() != null) {
                    newObjectForMessage.setData(new ArrayList<>(field13.getData()));
                } else {
                    newObjectForMessage.setData(new ArrayList<>());
                }
                this.field13 = newObjectForMessage;
            } else {
                this.field13 = null;
            }
        }
